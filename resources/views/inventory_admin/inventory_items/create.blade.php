   ...
   <div class="section-body">
      ...
      <div class="row mt-sm-4">
         <div class="col-12 col-md-12 col-lg-12">
            <div class="card">
               <form action="{{ route('inventory_admin.inventoryitems.store') }}" enctype="multipart/form-data" method="post" novalidate="">
                  @csrf
                        ...
                        <div class="col-md-8 col-12">
                           <div class="row">
                              <div class="form-group col-md-6 col-12">
                                 <label>Kode </label>
                                 <input type="text" class="form-control @error('code') is-invalid @enderror" name="code" value="{{ old('code') }}" placeholder="Masukkan Kode" autocomplete="off">
                              ...
                              <div class="form-group col-md-6 col-12">
                                 <label>Merek</label>
                                 <input type="text" class="form-control @error('brand') is-invalid @enderror" name="brand" value="{{ old('brand') }}" placeholder="Masukkan Merek" autocomplete="off">
                                 <x-invalid-feedback field='brand'></x-invalid-feedback>
                              </div>
                              <div class="form-group col-md-6 col-12">
                                 <label>Spesifikasi</label>
                                 <input type="text" class="form-control @error('spesification') is-invalid @enderror" name="spesification" value="{{ old('spesification') }}" placeholder="Masukkan Spesifikasi" autocomplete="off">
                              ...
                              <div class="form-group col-md-6 col-12">
                                 ...
                                 <select class="form-control selectric" name="capacity_pk">
                                     ...
                                     @foreach($capacities as $capacity)
                                         <option value="{{ $capacity }}" {{ old('capacity_pk') == $capacity ? 'selected' : '' }}>
                                             {{ $capacity }} PK
                                         </option>
                                     @endforeach
                                 </select>
                              ...
                              <div class="form-group col-md-6 col-12">
                                 <label>Garansi</label>
                                 <input type="text" class="form-control @error('warranty') is-invalid @enderror" name="warranty" value="{{ old('warranty') }}" placeholder="Masukkan Garansi" autocomplete="off">
                                 <x-invalid-feedback field='warranty'></x-invalid-feedback>
                                 <div class="form-text text-muted">Contoh : 3 Tahun</div>
                              </div>
                              <div class="form-group col-md-6 col-12">
                              ...
                              <div class="form-group col-md-6 col-12">
                                 ...
                                 <input type="number" min="0" class="form-control @error('stock') is-invalid @enderror" name="stock" value="{{ old('stock') }}" placeholder="Masukkan Jumlah" autocomplete="off">
                              ...
                              <div class="form-group col-md-6 col-12">
                                 ...
                                 <select class="form-control select2" name="unit_id">
                                    ...
                                    <option value="{{ $item->id }}" {{ old('unit_id') == $item->id ? 'selected' : '' }}>{{ $item->name }}{{ $item->symbol ? ' (' . $item->symbol . ')' : '' }}</option>
                                    @endforeach
                                 </select>
                                 @error('unit_id')
                                 <div class="form-text text-danger">{{ $message }}</div>
                              ...
                              <div class="form-group col-md-12 col-12">
                                 ...
                                 <input type="text" min="0" class="form-control @error('description') is-invalid @enderror" name="description" value="{{ old('description') }}" placeholder="Masukkan Keterangan" autocomplete="off">
