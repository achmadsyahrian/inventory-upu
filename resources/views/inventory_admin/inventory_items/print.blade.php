...
<body>
                ...
                <tr>
                    ...
                    <td class="">
                        <div id="page-num-container">
                            <span style="width: 120px; display: inline-block">Halaman</span> : <span
    ...
    @foreach ($chunkedData as $index => $dataChunk)
         @php
            $itemsPerPage = $index === 0 ? 15 : 20;
            $startNumber = $index === 0 ? 1 : (15 + ($index - 1) * 20 + 1);
         @endphp
        <div class="container"
    ...
    <footer>
        ...
        <div class="signature-path">
                ...
                <tbody>
                    ...
                    <tr style="margin-top:20px;">
                        <td style="padding-top: 40px;">
                            {{-- <img src="{{ asset('image/ttd/puskom.png') }}" alt="Tanda Tangan Kabag Inventori" width="60" style="display: block; text-align: left;"> --}}
                        </td>
                        <td style="padding-top: 40px;">
                            {{-- <img src="{{ asset('image/ttd/kabag.png') }}" alt="Tanda Tangan Kabag Umum" width="60"> --}}
                        </td>
                        <td style="padding-top: 40px;">
            ...
            <p style="position: fixed; font-size:12px; left:10%; margin:auto;"><i>Dokumen ini milik Universitas Potensi
                    Utama, Dilarang memperbanyak atau menggunakan informasi didalamnya tanpa persetujuan Universitas
                    Potensi Utama</i></p>
        </div>
    </footer>
</body>
