            ...
            <thead>
                <tr>
                    ...
                    <td class="header-cell" style="width: 30%;">
                        <strong>NO. DOKUMEN</strong><br>F-/SPMI/06-04-01
                    </td>
                </tr>
                <tr>
                    <td colspan="2" rowspan="2" class="header-cell">
                        <strong>JUDUL</strong><br>REKAPITULASI PERMINTAAN KEBUTUHAN BARANG
                    </td>
                    <td class="" style="font-size:14px;">
                        <span style="width: 90px;"> Tanggal Terbit </span> : 08 April 2019
                    </td>
                </tr>
                <tr>
                    <td class="" style="font-size:14px;">
                        <span style="=width: 90px;"> Tanggal Efektif </span> : 15 April 2019
                    </td>
                </tr>
                <tr>
                    <td colspan="2" rowspan="2" class="header-cell">
        ...
        <div class="container" style="position: absolute; bottom: 0; width: 100%; left: 0; top: 200px;">
            <div class="flex-container" style="display: flex; justify-content: space-between; font-size: 13px;">
                <div style="position: absolute;">
                    <p>Bulan: {{ \Carbon\Carbon::create()->month($month)->locale('id')->translatedFormat('F') }} {{ $year }}</p>
                </div>
            </div>
