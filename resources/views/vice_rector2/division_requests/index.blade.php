               ...
               <div class="card-body">
                  <div class="float-right">
                     <div class="input-group">
                        ...
                        <form action="{{ route('vice_rector2.divisionrequests.index') }}" method="GET" style="display:inline;">
                     ...
                     <table class="table table-striped">
                        ...
                        @forelse ($data as $item)
                           <tr>
                             ...
                             <td>{{ $item->count ?? "--" }}</td>
                              <td>
                                 <a href="{{ route('vice_rector2.divisionrequests.detail', ['date' => $item->date, 'division' => $item->division_id]) }}" class="btn btn-primary btn-action mr-1" data-toggle="tooltip" title="Lihat Detail"><i class="fas fa-eye"></i> Detail Permintaan</a>
                              </td>
                           </tr>
                        @empty
                            <tr>
...
@include('vice_rector2.division_requests.modal')
@endsection