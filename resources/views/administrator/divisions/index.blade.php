...
<div class="section">
   ...
   <div class="section-header">
      ...
      <div class="section-header-button">
         <a href="{{ route('administrator.divisions.create') }}" class="btn btn-primary">Tambah</a>
      </div>
               ...
               <div class="card-body">
                  <div class="float-right">
                     <div class="input-group">
                        ...
                        <form action="{{ route('administrator.divisions.index') }}" method="GET" style="display:inline;">
                        ...
                        @forelse ($data as $item)
                           <tr>
                             ...
                             <td>{{ $item->division_head ?? '--' }}</td>
                              ...
                              <td>
                                 <a href="{{ route('administrator.divisions.edit', [$item]) }}" class="btn btn-primary btn-action mr-1" data-toggle="tooltip" title="Edit"><i class="fas fa-pencil-alt"></i></a>
                                 <form class="d-inline" action="{{ route('administrator.divisions.destroy', $item) }}" method="post" id="delete-data-{{ $item->id }}">
                                    @method('delete')
                                    @csrf
...
@include('administrator.divisions.modal')
@endsection