...
<div class="section">
   ...
   <div class="section-header">
      ...
      <div class="section-header-button">
         <a href="{{ route('administrator.users.create') }}" class="btn btn-primary">Tambah</a>
      </div>
               ...
               <div class="card-body">
                  <div class="float-right">
                     <div class="input-group">
                        ...
                        <form action="{{ route('administrator.users.index') }}" method="GET" style="display:inline;">
                     ...
                     <table class="table table-striped">
                        ...
                        @forelse ($data as $item)
                           <tr>
                              ...
                              <td>
                                 <a href="{{ $item->division ? route('administrator.divisions.edit', $item->division) : '#' }}">
                              ...
                              <td>
                                 <a href="{{ route('administrator.users.edit', [$item]) }}" class="btn btn-primary btn-action mr-1" data-toggle="tooltip" title="Edit"><i class="fas fa-pencil-alt"></i></a>
...
@include('administrator.users.modal')
@endsection