...
class DivisionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('administrator.divisions.index', compact('data', 'conditions', 'buildings'));
    }
    ...
    public function create()
    {
        $conditions = DivisionCondition::select('id', 'name')->get();
        $buildings = Building::select('id', 'name')->get();
        return view('administrator.divisions.create', compact('conditions', 'buildings'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('administrator.divisions.index')->with('success', 'Divisi baru berhasil ditambahkan');
    }
    ...
    public function edit(Division $division)
    {
        $conditions = DivisionCondition::select('id', 'name')->get();
        $buildings = Building::select('id', 'name')->get();
        return view('administrator.divisions.edit', compact('division', 'buildings', 'conditions'));
    }
    ...
    public function update(Request $request, Division $division)
    {
        ...
        return redirect()->route('administrator.divisions.index')->with('success', 'Data divisi berhasil diperbarui');
    }
    ...
    {
        $division->delete();
        return redirect()->route('administrator.divisions.index')->with('success', 'Data divisi berhasil dihapus');
    }
